...
//        }
    ...
    var postManager = PostManager.instance
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        postManager.loadFollows(postsCollectionView: postsCollectionView)
    }
...
extension HomeVC:UIDocumentPickerDelegate,UINavigationControllerDelegate, UIImagePickerControllerDelegate{
...
enum PostType:String {
    case image,movie,document,none
}
